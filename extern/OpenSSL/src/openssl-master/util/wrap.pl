...
BEGIN {
    ...
    require 'D:/Projects/WinNet/extern/OpenSSL/src/openssl-master/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/Projects/WinNet/extern/OpenSSL/src/openssl-master/test/fips-and-base.cnf';
    shift;
