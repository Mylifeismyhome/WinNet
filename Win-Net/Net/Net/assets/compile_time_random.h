...
#ifndef CUSTOM_RANDOM_SEED
#define CUSTOM_RANDOM_SEED 0xbdac'f99b'3f7a'1bb4ULL
#endif
...
#define RAND_NEXT (::Dynlec::CTRandomGeneratorValueSeeded<__COUNTER__>)
// generates a random number seeded with time and the custom seed between min and max ( [min, max[ )
#define RAND_NEXT_BETWEEN(min, max) (min + (::Net::Random::CTRandomGeneratorValueSeeded<__COUNTER__> % (max - min)))
...
namespace Net
{
	namespace Random
	{
		...
		template <uint64_t n, uint64_t seed = ::Net::Random::CTRandomSeed>
