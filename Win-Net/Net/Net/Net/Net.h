...
#define NET_OPT_USE_NTP (1 << 18)
#define NET_OPT_NTP_HOST (1 << 19)
#define NET_OPT_NTP_PORT (1 << 20)
#define NET_OPT_USE_2FA (1 << 21)
#define NET_OPT_2FA_INTERVAL (1 << 21)
#define NET_OPT_NTP_SYNC_INTERVAL (1 << 22)

/* DEFAULT OPTION VALUES */
#define NET_OPT_DEFAULT_MAX_PACKET_SIZE 512
...
#define NET_OPT_DEFAULT_USE_2FA false
#define NET_OPT_DEFAULT_2FA_INTERVAL 30
#define NET_OPT_DEFAULT_NTP_SYNC_INTERVAL 1000
